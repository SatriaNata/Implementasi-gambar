...
<html>
     ...
     <div id="content">
          <span class="slide">
               <a href="#" oneclick="openSlideMenu()">
                    <i class="fas fa-caret-right" ></i>
               </a>
          </span>
          <div id="menu" class="nav">
               <a href="#" class="close" oneclick="closeSlideMenu()">
                    <i class="fas fa-caret-left"></i>
               </a>
               <a href="#">Penyaluran Dana PIP 2018 &nbsp <i class="fas fa-angle-down"></i></a>
               <a href="#">Penyaluran Dana PIP 2017 &nbsp <i class="fas fa-angle-down"></i></a>
               <a href="#">Penyaluran Dana PIP 2016 &nbsp <i class="fas fa-angle-down"></i></a>
               <a href="#">Penyaluran Dana PIP 2015 &nbsp <i class="fas fa-angle-down"></i></a>
          </div>
          <h1>Responsive </h1>
